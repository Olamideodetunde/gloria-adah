              ...
              <div className="space-y-8">
                <div className="bg-primary text-primary-foreground p-8">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <a href="mailto:info@gloriaondahlaw.com" className="flex items-center gap-3 text-sm hover:text-secondary transition-colors"><Mail className="h-4 w-4 text-secondary" />info@gloriaondahlaw.com</a>
                  </div>
