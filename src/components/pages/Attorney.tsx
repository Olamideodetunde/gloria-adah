              ...
              <div className="lg:col-span-4 space-y-8">
                ...
                <div className="bg-muted p-8 border border-border">
                  ...
                  <div className="space-y-4 text-sm text-muted-foreground">
                    ...
                    <a href="mailto:info@gloriaondah.com" className="flex items-center gap-3 hover:text-secondary break-all"><Mail className="h-4 w-4 text-secondary shrink-0" />info@gloriaondah.com</a>
