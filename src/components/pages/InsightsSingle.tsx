...
import { ArrowLeft, Share2, Linkedin } from 'lucide-react';
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <div className="aspect-[21/9] w-full bg-muted mb-12">
              <img src="/images/insight-1.png" alt="Article hero" className="w-full h-full object-cover" />
            </div>
            ...
            <div className="prose prose-lg prose-slate max-w-none prose-headings:font-serif prose-headings:text-primary prose-a:text-secondary prose-p:text-muted-foreground prose-li:text-muted-foreground">
              ...
              <p>An annual return is not a financial statement or a tax return. Rather, it is a mandatory yearly filing that confirms to the CAC that your business is still active and operational.</p>
              ...
              <ul>
                ...
                <li><strong>Limited Liability Companies (LTD):</strong> Must be filed within 42 days after the Annual General Meeting (AGM).</li>
              ...
              <p>If a company fails to file its annual returns, it is classified as "Inactive" on the CAC portal. The CAC imposes daily default penalties and may strike the company's name off the register entirely.</p>

              <h2>How We Can Help</h2>
              <p>At Gloria Ondah & Associates, we manage the entire compliance calendar for our clients. We prepare the necessary documents, liaise with auditors, and ensure prompt filing on the CAC portal.</p>
            </div>

            <div className="mt-16 pt-8 border-t border-border flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full overflow-hidden">
                  <img src="/images/gloria.png" alt="Gloria Ondah" className="w-full h-full object-cover" />
                </div>
                <div>
