          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-12 max-w-md">
                We are available to answer your inquiries and discuss how we can assist with your legal needs. Reach out via form, email, or phone.
              </p>
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Phone: 09029633193<br/>WhatsApp: 07054588490</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">G.ondahlawoffice@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="bg-muted/30 p-8 md:p-12 border border-border">
              {isSubmitted ? (
                <div className="h-full flex flex-col items-center justify-center text-center space-y-6 py-12">
                  ...
                  <div className="bg-background border border-border px-6 py-3 rounded text-sm font-mono">
                    Reference: {refId}
                  </div>
                  <div className="text-xs text-muted-foreground mt-8 pt-8 border-t border-border">
                    Demo submission — production deployment will route this to your inbox via SMTP.
                  </div>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="John Doe" className="bg-background rounded-none h-12" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="john@example.com" className="bg-background rounded-none h-12" {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="090..." className="bg-background rounded-none h-12" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="E.g., Corporate Registration Inquiry" className="bg-background rounded-none h-12" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea placeholder="How can we help you?" className="bg-background rounded-none min-h-[150px] resize-none" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                          ...
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 bg-background">
                            ...
                            <div className="space-y-1 leading-none">
                              <FormLabel className="text-xs text-muted-foreground font-normal">
                                I consent to Gloria Ondah & Associates collecting and processing my data in accordance with the NDPR and the Privacy Policy.
                              </FormLabel>
                              <FormMessage />
                            </div>
                          </FormItem>
