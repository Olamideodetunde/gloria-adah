...
import { getPracticeRoute, routes } from '../_shared/routes';
    ...
    return (
      <PageShell title="Practice Area Not Found" breadcrumbs={[{ label: 'Practice Areas', href: routes.practiceAreas }]}>
        <div className="container mx-auto px-6 py-24 text-center">
          ...
          <a href={routes.practiceAreas}>
            <Button>Return to Practice Areas</Button>
          </a>
        </div>
      </PageShell>
    );
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {area.who_for.map((who, i) => (
                      <span key={i} className="px-4 py-2 bg-muted text-primary text-sm font-medium border border-border rounded-full">
                        {who}
                      </span>
                    ))}
                  </div>
              ...
              <div className="space-y-8">
                <div className="bg-primary text-primary-foreground p-8">
                  ...
                  <p className="text-primary-foreground/80 mb-8 text-sm">
                    Schedule a consultation to discuss your specific needs with our legal experts.
                  </p>
                  
                  <div className="space-y-4 mb-8">
                    <a href="tel:+2349029633193" className="flex items-center gap-3 text-sm hover:text-secondary transition-colors">
                      <Phone className="h-4 w-4 text-secondary" />
                      09029633193
                    </a>
                    <a href="https://wa.me/2347054588490" className="flex items-center gap-3 text-sm hover:text-secondary transition-colors">
                      <MessageCircle className="h-4 w-4 text-secondary" />
                      07054588490
                    </a>
                    <a href="mailto:G.ondahlawoffice@gmail.com" className="flex items-center gap-3 text-sm hover:text-secondary transition-colors">
                  ...
                  <a href={routes.booking} className="block w-full">
                    <Button className="w-full bg-white text-primary hover:bg-white/90 rounded-none h-12">
                      Book Consultation
                    </Button>
                  </a>
                </div>
