              ...
              <div className="lg:col-span-4 space-y-8">
                ...
                <div className="bg-muted p-8 border border-border">
                  ...
                  <div className="space-y-4 text-sm text-muted-foreground">
                    <a href="tel:+2349029633193" className="flex items-center gap-3 hover:text-secondary">
                      <Phone className="h-4 w-4 text-secondary" />
                      09029633193
                    </a>
                    <a href="mailto:G.ondahlawoffice@gmail.com" className="flex items-center gap-3 hover:text-secondary break-all">
                      <Mail className="h-4 w-4 text-secondary shrink-0" />
                      G.ondahlawoffice@gmail.com
                    </a>
              ...
              <div className="lg:col-span-8">
                ...
                >
                  ...
                  <div className="space-y-6 text-muted-foreground leading-relaxed text-lg mb-12">
                    ...
                    <motion.p variants={fadeInUp}>
                      Beyond corporate law, Gloria is a skilled negotiator and dispute resolution specialist. As an Associate of the Chartered Institute of Arbitrators (UK) and a Certified Management Consultant, she actively advocates for alternative dispute resolution mechanisms to save clients time and preserve business relationships.
                    </motion.p>
                  </div>
                  ...
                  <motion.div variants={fadeInUp} className="mb-12">
                    ...
                    <ul className="grid sm:grid-cols-2 gap-4 text-muted-foreground">
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Corporate Structuring & Registration</li>
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Commercial Contract Drafting</li>
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Regulatory Compliance & Audits</li>
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Dispute Resolution & Arbitration</li>
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Real Estate Transactions</li>
                      <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-secondary" /> Energy Sector Advisory</li>
                    </ul>
                  </motion.div>
