...
import { getInsightRoute } from '../_shared/routes';
...
const articles = [
  {
    ...
    excerpt: "Understanding the timeline, requirements, and penalties associated with Corporate Affairs Commission annual returns for Nigerian businesses.",
    image: "insight-1.png",
    featured: true
  },
  {
  ...
  },
  {
    ...
    category: "Compliance",
    date: "Jul 02, 2023",
    title: "Essential Clauses for Remote Work Contracts",
    excerpt: "How to draft employment agreements that protect your company while accommodating hybrid and remote work models.",
    image: "insight-1.png",
    featured: false
  },
  {
    ...
    category: "Tax",
    date: "Jun 18, 2023",
    title: "Obtaining Your Tax Clearance Certificate (TCC)",
    excerpt: "Step-by-step guidance on securing your TCC and its importance for participating in public tenders.",
    image: "insight-2.png",
    featured: false
  },
  {
    ...
    category: "Property",
    date: "May 05, 2023",
    title: "Due Diligence in Abuja Real Estate Acquisitions",
    excerpt: "Common pitfalls and title verification procedures when purchasing land in the Federal Capital Territory.",
    image: "insight-3.png",
    featured: false
  }
];
              ...
              >
                <div className="grid lg:grid-cols-2 gap-12 items-center bg-muted/20 border border-border p-6 lg:p-12 hover:border-secondary/50 transition-colors">
                  <div className="aspect-[4/3] lg:aspect-square w-full overflow-hidden">
                    <img 
                      src={`/__mockup/images/${featured.image}`} 
                      alt={featured.title} 
                  ...
                  <div>
                    ...
                    <h2 className="text-4xl lg:text-5xl font-serif text-primary mb-6 leading-tight group-hover:text-secondary transition-colors">
                      {featured.title}
                    </h2>
                    <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                      {featured.excerpt}
                    </p>
                    <span className="text-sm font-bold uppercase tracking-wider text-primary border-b-2 border-secondary pb-1">
                      Read Article
                    </span>
                  </div>
                </div>
            ...
            >
              {regular.map((post, i) => (
                <motion.a 
                  ...
                  variants={fadeInUp}
                  className="group block border border-transparent hover:border-border p-4 -m-4 transition-colors"
                >
                  <div className="aspect-[4/3] mb-6 overflow-hidden bg-muted">
                    <img 
                      src={`/__mockup/images/${post.image}`} 
                      alt={post.title} 
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
                    />
                  </div>
