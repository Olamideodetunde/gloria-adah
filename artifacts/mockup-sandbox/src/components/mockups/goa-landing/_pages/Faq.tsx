...
const faqs = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "I missed my annual returns filing. Can you help?", a: "Yes. We can calculate your outstanding penalty fees, prepare the required documents (including coordinating with auditors if necessary), and file all outstanding returns to restore your company to 'Active' status." },
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6 max-w-4xl">
            <SectionHeader 
              ...
              description="Find answers to questions about our processes, timelines, and services."
            />
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    {group.questions.map((item, i) => (
                      <AccordionItem key={i} value={`item-${idx}-${i}`} className="border-border">
                        <AccordionTrigger className="text-left font-medium text-foreground hover:text-secondary text-lg">
                          {item.q}
                        </AccordionTrigger>
            ...
            <div className="mt-20 p-8 bg-muted text-center border border-border">
              ...
              <a href="/#/contact" className="inline-block px-8 py-3 bg-primary text-white font-medium hover:bg-primary/90 transition-colors">
                Contact Us
              </a>
            </div>
          </div>
